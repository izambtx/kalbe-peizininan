...
class Hydrant extends BaseController
{
    ...
    public function index($id = false)
    {
        ...
        if ($pemohon) {
            ...
            $this->builder->where('izin_fasilitas.id_kategori', 2);
            $status = ['ON', 'OFF'];
        ...
        return view('/IzinFasilitas/List/ListHydrant', $data);
    }
    ...
    public function detail($id = false)
    {
        ...
        $data = [
            'title' => 'Detail Izin Akses Hydrant',
            'kategori' => $this->kategoriModel->getKategori(),
        ...
        return view('/IzinFasilitas/Detail/DetailsHydrant', $data);
    }
    ...
    public function listPenonAktifan($id = false)
    {
        ...
        $data = [
            'title' => 'List Penon-aktifan Akses Hydrant',
            'kategori' => $this->kategoriModel->getKategori(),
            'page' => $page,
            'perPage' => $perPage,
            'total' => $total,
        ...
        return view('/IzinFasilitas/List/PenonAktifanHydrant', $data);
    }

    public function create($id = false)
    {
        $data = [
            'title' => 'Create Izin Akses Hydrant',
            'kategori' => $this->kategoriModel->getKategori(),
            'inputFotoPE' => $this->request->getVar('jumlahFoto'),
            'countRegNo' => $this->hydrantModel->getRegNoHydrant(),
            'lokasi' => $this->lokasiModel->getLokasi()
        ];

        return view('/IzinFasilitas/FormInput/CreateHydrant', $data);
    }
    ...
    public function save($id = false)
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/IzinFasilitas/Hydrant/CreateIzin')->withInput()->with('validation', $validation);
        }

        $this->hydrantModel->save([
            'id_kategori' => 2,
            'lokasi' => $this->request->getVar('lokasi'),
        ...
        $id_izin = $this->hydrantModel->getInsertID();
        ...
        return redirect()->to('/IzinFasilitas/Hydrant')->with('pesan', 'Izin Berhasil Ditambahkan');
    }

    public function edit($id = false)
    {
        $data = [
            'title' => 'Edit Izin Akses Hydrant',
            'kategori' => $this->kategoriModel->getKategori(),
            'inputFotoPE' => $this->request->getVar('jumlahFoto'),
            'fotoPE' => $this->fotopeModel->getFotoPe($id),
            'countFotoPE' => $this->fotopeModel->getCountFotoPe($id),
            'countRegNo' => $this->hydrantModel->getRegNoHydrant(),
            'pintu' => $this->hydrantModel->getHydrant($id),
            'lokasi' => $this->lokasiModel->getLokasi()
        ];

        return view('/IzinFasilitas/FormInput/EditHydrant', $data);
    }
    ...
    public function update($id = false)
    {
        ...
        if (!$this->validate([
            ...
            $validation = $this->validator->getErrors();
            return redirect()->to('/IzinFasilitas/Hydrant/EditIzin')->withInput()->with('validation', $validation);
        }
        ...
        return redirect()->to('/IzinFasilitas/Hydrant')->with('pesan', 'Izin Berhasil Diupdate');
    }
    ...
    public function detailPenonAktifan($id = false)
    {
        ...
        $data = [
            'title' => 'Detail Penon-aktifan Akses Hydrant',
            'kategori' => $this->kategoriModel->getKategori(),
            'foto_izin' => $this->db->table('foto_izin_fasilitas')->getWhere(['id_izin' => $id])->getResultArray(),
        ...
        return view('/IzinFasilitas/Detail/DetailsAktifHydrant', $data);
    }
    ...
    public function nonAktif($id)
    {
        ...
        if (!$this->validate([
            ...
            $validation = $this->validator->getErrors();
            return redirect()->to('/PenonAktifanFasilitas/Hydrant/Details/' . $id)->withInput()->with('validation', $validation);
        }
        ...
        return redirect()->to('/PenonAktifanFasilitas/Hydrant/Details/' . $id)->with('pesan', 'Fasilitas Telah Di Non-aktifkan');
    }
    ...
    public function Aktif($id)
    {
        ...
        if (!$this->validate([
            ...
            $validation = $this->validator->getErrors();
            return redirect()->to('/PenonAktifanFasilitas/Hydrant/Details/' . $id_izin)->withInput()->with('validation', $validation);
        }
        ...
        return redirect()->to('/PenonAktifanFasilitas/Hydrant/Details/' . $id_izin)->with('pesan', 'Fasilitas Telah Di Aktifkan Kembali');
    }
    ...
    public function request($id)
    {
        ...
        return redirect()->to('/IzinFasilitas/Hydrant/Details/' . $id)->with('pesan', 'Permohonan Extend Izin Berhasil Diapprove');
    }
    ...
    public function listApprover($id = false)
    {
        ...
        return view('/ApproveFasilitas/List/ListHydrant', $data);
    }
    ...
    public function detailApprover($id = false)
    {
        ...
        $data = [
            'title' => 'Detail Izin Akses Hydrant',
            'kategori' => $this->kategoriModel->getKategori(),
            'noReg' => $this->hydrantModel->getRegNoHydrant(),
        ...
        return view('/ApproveFasilitas/Detail/DetailsHydrant', $data);
    }
    ...
    public function approve($id)
    {
        ...
        return redirect()->to('/HistoryFasilitas/Hydrant')->with('pesan', 'Izin Berhasil Diapprove');
    }
    ...
    public function rejected($id)
    {
        ...
        return redirect()->to('/HistoryFasilitas/Hydrant')->with('pesan', 'Izin Berhasil Direject');
    }
    ...
    public function returned($id)
    {
        ...
        return redirect()->to('/HistoryFasilitas/Hydrant')->with('pesan', 'Izin Berhasil Direturn');
    }
    ...
    public function listPengaktifan($id = false)
    {
        ...
        $data = [
            'title' => 'List Pengaktifan Akses Hydrant',
            'kategori' => $this->kategoriModel->getKategori(),
            'page' => $page,
            'perPage' => $perPage,
            'total' => $total,
        ...
        return view('/ApproveFasilitas/List/PengaktifanHydrant', $data);
    }
    ...
    public function detailPengaktifan($id = false)
    {
        ...
        $data = [
            'title' => 'Detail Pengaktifan Akses Hydrant',
            'kategori' => $this->kategoriModel->getKategori(),
            'foto_izin' => $this->db->table('foto_izin_fasilitas')->getWhere(['id_izin' => $id])->getResultArray(),
            'aktifasi_on' => $this->aktifasiModel->getUserAktifasi($id),
            'aktifasi_pic' => $this->aktifasiModel->getUserAktifasi2($id),
        ...
        return view('/ApproveFasilitas/Detail/DetailsAktifHydrant', $data);
    }
    ...
    public function PICPengaktifan($id)
    {
        ...
        return redirect()->to('/PengaktifanFasilitas/Hydrant/Details/' . $id)->with('pesan', 'Izin Pengaktifan Berhasil Diapprove');
    }
    ...
    public function listHistory($id = false)
    {
        ...
        $data = [
            'title' => 'List History Perizinan Hydrant',
            'kategori' => $this->kategoriModel->getKategori(),
            'page' => $page,
            'perPage' => $perPage,
            'total' => $total,
        ...
        return view('/ApproveFasilitas/List/HistoryHydrant', $data);
    }
    ...
    public function listExtend($id = false)
    {
        ...
        $data = [
            'title' => 'List Extended Perizinan Hydrant',
            'kategori' => $this->kategoriModel->getKategori(),
            'page' => $page,
            'perPage' => $perPage,
            'total' => $total,
        ...
        return view('/ApproveFasilitas/List/ExtendHydrant', $data);
    }
    ...
    public function extend($id)
    {
        ...
        return redirect()->to('/ExtendFasilitas/Hydrant')->with('pesan', 'Permohonan Extend Izin Berhasil Diapprove');
    }
}
