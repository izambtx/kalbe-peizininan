...
class PintuEmergency extends BaseController
{
    ...
    public function index($id = false)
    {
        ...
        if ($pemohon) {
            ...
            $this->builder->where('izin_fasilitas.id_kategori', 1);
            $status = ['ON', 'OFF'];
        ...
        $data = [
            'title' => 'List Izin Akses Pintu Emergency',
        ...
        return view('/IzinFasilitas/List/ListPintuEmergency', $data);
    }
    ...
    public function detail($id = false)
    {
        ...
        $data = [
            'title' => 'Detail Izin Akses Pintu Emergency',
            'kategori' => $this->kategoriModel->getKategori(),
        ...
        return view('/IzinFasilitas/Detail/DetailsPintuEmergency', $data);
    }
    ...
    public function listPenonAktifan($id = false)
    {
        ...
        $data = [
            'title' => 'List Penon-aktifan Akses Pintu Emergency',
            'kategori' => $this->kategoriModel->getKategori(),
            'page' => $page,
            'perPage' => $perPage,
            'total' => $total,
        ...
        return view('/IzinFasilitas/List/PenonAktifanPintuEmergency', $data);
    }

    public function create($id = false)
    {
        $data = [
            'title' => 'Create Izin Akses Pintu Emergency',
            'kategori' => $this->kategoriModel->getKategori(),
            'inputFotoPE' => $this->request->getVar('jumlahFoto'),
            'countRegNo' => $this->pintuModel->getRegNoPintu(),
            'lokasi' => $this->lokasiModel->getLokasi()
        ];

        return view('/IzinFasilitas/FormInput/CreatePintuEmergency', $data);
    }
    ...
    public function save($id = false)
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/IzinFasilitas/PintuEmergency/CreateIzin')->withInput()->with('validation', $validation);
        }

        $this->pintuModel->save([
            'id_kategori' => 1,
            'lokasi' => $this->request->getVar('lokasi'),
        ...
        $id_izin = $this->pintuModel->getInsertID();
        ...
        return redirect()->to('/IzinFasilitas/PintuEmergency')->with('pesan', 'Izin Berhasil Ditambahkan');
    }

    public function edit($id = false)
    {
        $data = [
            'title' => 'Edit Izin Akses Pintu Emergency',
            'kategori' => $this->kategoriModel->getKategori(),
            'inputFotoPE' => $this->request->getVar('jumlahFoto'),
            'fotoPE' => $this->fotopeModel->getFotoPe($id),
            'countFotoPE' => $this->fotopeModel->getCountFotoPe($id),
            'countRegNo' => $this->pintuModel->getRegNoPintu(),
            'pintu' => $this->pintuModel->getPintu($id),
            'lokasi' => $this->lokasiModel->getLokasi()
        ];

        return view('/IzinFasilitas/FormInput/EditPintuEmergency', $data);
    }
    ...
    public function update($id = false)
    {
        ...
        if (!$this->validate([
            ...
            $validation = $this->validator->getErrors();
            return redirect()->to('/IzinFasilitas/PintuEmergency/EditIzin')->withInput()->with('validation', $validation);
        }
        ...
        return redirect()->to('/IzinFasilitas/PintuEmergency')->with('pesan', 'Izin Berhasil Diupdate');
    }
    ...
    public function detailPenonAktifan($id = false)
    {
        ...
        $data = [
            'title' => 'Detail Penon-aktifan Akses Pintu Emergency',
            'kategori' => $this->kategoriModel->getKategori(),
            'foto_izin' => $this->db->table('foto_izin_fasilitas')->getWhere(['id_izin' => $id])->getResultArray(),
        ...
        return view('/IzinFasilitas/Detail/DetailsAktifPintuEmergency', $data);
    }
    ...
    public function nonAktif($id)
    {
        ...
        if (!$this->validate([
            ...
            $validation = $this->validator->getErrors();
            return redirect()->to('/PenonAktifanFasilitas/PintuEmergency/Details/' . $id)->withInput()->with('validation', $validation);
        }
        ...
        return redirect()->to('/PenonAktifanFasilitas/PintuEmergency/Details/' . $id)->with('pesan', 'Fasilitas Telah Di Non-aktifkan');
    }
    ...
    public function Aktif($id)
    {
        ...
        if (!$this->validate([
            ...
            $validation = $this->validator->getErrors();
            return redirect()->to('/PenonAktifanFasilitas/PintuEmergency/Details/' . $id_izin)->withInput()->with('validation', $validation);
        }
        ...
        return redirect()->to('/PenonAktifanFasilitas/PintuEmergency/Details/' . $id_izin)->with('pesan', 'Fasilitas Telah Di Aktifkan Kembali');
    }
    ...
    public function request($id)
    {
        ...
        return redirect()->to('/IzinFasilitas/PintuEmergency/Details/' . $id)->with('pesan', 'Permohonan Extend Izin Berhasil Diapprove');
    }
    ...
    public function listApprover($id = false)
    {
        ...
        return view('/ApproveFasilitas/List/ListPintuEmergency', $data);
    }
    ...
    public function detailApprover($id = false)
    {
        ...
        $data = [
            'title' => 'Detail Izin Akses Pintu Emergency',
            'kategori' => $this->kategoriModel->getKategori(),
            'noReg' => $this->pintuModel->getRegNoPintu(),
        ...
        return view('/ApproveFasilitas/Detail/DetailsPintuEmergency', $data);
    }
    ...
    public function approve($id)
    {
        ...
        return redirect()->to('/HistoryFasilitas/PintuEmergency')->with('pesan', 'Izin Berhasil Diapprove');
    }
    ...
    public function rejected($id)
    {
        ...
        return redirect()->to('/HistoryFasilitas/PintuEmergency')->with('pesan', 'Izin Berhasil Direject');
    }
    ...
    public function returned($id)
    {
        ...
        return redirect()->to('/HistoryFasilitas/PintuEmergency')->with('pesan', 'Izin Berhasil Direturn');
    }
    ...
    public function listPengaktifan($id = false)
    {
        ...
        $data = [
            'title' => 'List Pengaktifan Akses Pintu Emergency',
            'kategori' => $this->kategoriModel->getKategori(),
            'page' => $page,
            'perPage' => $perPage,
            'total' => $total,
        ...
        return view('/ApproveFasilitas/List/PengaktifanPintuEmergency', $data);
    }
    ...
    public function detailPengaktifan($id = false)
    {
        ...
        $data = [
            'title' => 'Detail Pengaktifan Akses Pintu Emergency',
            'kategori' => $this->kategoriModel->getKategori(),
            'foto_izin' => $this->db->table('foto_izin_fasilitas')->getWhere(['id_izin' => $id])->getResultArray(),
            'aktifasi_on' => $this->aktifasiModel->getUserAktifasi($id),
            'aktifasi_pic' => $this->aktifasiModel->getUserAktifasi2($id),
        ...
        return view('/ApproveFasilitas/Detail/DetailsAktifPintuEmergency', $data);
    }
    ...
    public function PICPengaktifan($id)
    {
        ...
        return redirect()->to('/PengaktifanFasilitas/PintuEmergency/Details/' . $id)->with('pesan', 'Izin Pengaktifan Berhasil Diapprove');
    }
    ...
    public function listHistory($id = false)
    {
        ...
        $data = [
            'title' => 'List History Perizinan Pintu Emergency',
            'kategori' => $this->kategoriModel->getKategori(),
            'page' => $page,
            'perPage' => $perPage,
            'total' => $total,
        ...
        return view('/ApproveFasilitas/List/HistoryPintuEmergency', $data);
    }
    ...
    public function listExtend($id = false)
    {
        ...
        $data = [
            'title' => 'List Extended Perizinan Pintu Emergency',
            'kategori' => $this->kategoriModel->getKategori(),
            'page' => $page,
            'perPage' => $perPage,
            'total' => $total,
        ...
        return view('/ApproveFasilitas/List/ExtendPintuEmergency', $data);
    }
    ...
    public function extend($id)
    {
        ...
        return redirect()->to('/ExtendFasilitas/PintuEmergency')->with('pesan', 'Permohonan Extend Izin Berhasil Diapprove');
    }
}
