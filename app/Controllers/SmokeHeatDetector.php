...
class SmokeHeatDetector extends BaseController
{
    ...
    public function index($id = false)
    {
        ...
        if ($pemohon) {
            ...
            $this->builder->where('izin_fasilitas.id_kategori', 3);
            $status = ['ON', 'OFF'];
        ...
        $data = [
            'title' => 'List Izin Akses Smoke / Heat Detector',
        ...
        return view('/IzinFasilitas/List/ListSmokeHeatDetector', $data);
    }
    ...
    public function detail($id = false)
    {
        ...
        $data = [
            'title' => 'Detail Izin Akses Smoke / Heat Detector',
            'kategori' => $this->kategoriModel->getKategori(),
        ...
        return view('/IzinFasilitas/Detail/DetailsSmokeHeatDetector', $data);
    }
    ...
    public function listPenonAktifan($id = false)
    {
        ...
        $data = [
            'title' => 'List Penon-aktifan Akses Smoke / Heat Detector',
            'kategori' => $this->kategoriModel->getKategori(),
            'page' => $page,
            'perPage' => $perPage,
            'total' => $total,
        ...
        return view('/IzinFasilitas/List/PenonAktifanSmokeHeatDetector', $data);
    }

    public function create($id = false)
    {
        $data = [
            'title' => 'Create Izin Akses Smoke / Heat Detector',
            'kategori' => $this->kategoriModel->getKategori(),
            'inputFotoPE' => $this->request->getVar('jumlahFoto'),
            'countRegNo' => $this->smokeModel->getRegNoSmoke(),
            'lokasi' => $this->lokasiModel->getLokasi()
        ];

        return view('/IzinFasilitas/FormInput/CreateSmokeHeatDetector', $data);
    }
    ...
    public function save($id = false)
    {
        ...
        if (!$this->validate([
            ...
            return redirect()->to('/IzinFasilitas/SmokeHeatDetector/CreateIzin')->withInput()->with('validation', $validation);
        }

        $this->smokeModel->save([
            'id_kategori' => 3,
            'lokasi' => $this->request->getVar('lokasi'),
        ...
        $id_izin = $this->smokeModel->getInsertID();
        ...
        return redirect()->to('/IzinFasilitas/SmokeHeatDetector')->with('pesan', 'Izin Berhasil Ditambahkan');
    }

    public function edit($id = false)
    {
        $data = [
            'title' => 'Edit Izin Akses Smoke / Heat Detector',
            'kategori' => $this->kategoriModel->getKategori(),
            'inputFotoPE' => $this->request->getVar('jumlahFoto'),
            'fotoPE' => $this->fotopeModel->getFotoPe($id),
            'countFotoPE' => $this->fotopeModel->getCountFotoPe($id),
            'countRegNo' => $this->smokeModel->getRegNoSmoke(),
            'pintu' => $this->smokeModel->getSmoke($id),
            'lokasi' => $this->lokasiModel->getLokasi()
        ];

        return view('/IzinFasilitas/FormInput/EditSmokeHeatDetector', $data);
    }
    ...
    public function update($id = false)
    {
        ...
        if (!$this->validate([
            ...
            $validation = $this->validator->getErrors();
            return redirect()->to('/IzinFasilitas/SmokeHeatDetector/EditIzin')->withInput()->with('validation', $validation);
        }
        ...
        return redirect()->to('/IzinFasilitas/SmokeHeatDetector')->with('pesan', 'Izin Berhasil Diupdate');
    }
    ...
    public function detailPenonAktifan($id = false)
    {
        ...
        $data = [
            'title' => 'Detail Penon-aktifan Akses Smoke / Heat Detector',
            'kategori' => $this->kategoriModel->getKategori(),
            'foto_izin' => $this->db->table('foto_izin_fasilitas')->getWhere(['id_izin' => $id])->getResultArray(),
        ...
        return view('/IzinFasilitas/Detail/DetailsAktifSmokeHeatDetector', $data);
    }
    ...
    public function nonAktif($id)
    {
        ...
        if (!$this->validate([
            ...
            $validation = $this->validator->getErrors();
            return redirect()->to('/PenonAktifanFasilitas/SmokeHeatDetector/Details/' . $id)->withInput()->with('validation', $validation);
        }
        ...
        return redirect()->to('/PenonAktifanFasilitas/SmokeHeatDetector/Details/' . $id)->with('pesan', 'Fasilitas Telah Di Non-aktifkan');
    }
    ...
    public function Aktif($id)
    {
        ...
        if (!$this->validate([
            ...
            $validation = $this->validator->getErrors();
            return redirect()->to('/PenonAktifanFasilitas/SmokeHeatDetector/Details/' . $id_izin)->withInput()->with('validation', $validation);
        }
        ...
        return redirect()->to('/PenonAktifanFasilitas/SmokeHeatDetector/Details/' . $id_izin)->with('pesan', 'Fasilitas Telah Di Aktifkan Kembali');
    }
    ...
    public function request($id)
    {
        ...
        return redirect()->to('/IzinFasilitas/SmokeHeatDetector/Details/' . $id)->with('pesan', 'Permohonan Extend Izin Berhasil Diapprove');
    }
    ...
    public function listApprover($id = false)
    {
        ...
        return view('/ApproveFasilitas/List/ListSmokeHeatDetector', $data);
    }
    ...
    public function detailApprover($id = false)
    {
        ...
        $data = [
            'title' => 'Detail Izin Akses Smoke / Heat Detector',
            'kategori' => $this->kategoriModel->getKategori(),
            'noReg' => $this->smokeModel->getRegNoSmoke(),
        ...
        return view('/ApproveFasilitas/Detail/DetailsSmokeHeatDetector', $data);
    }
    ...
    public function approve($id)
    {
        ...
        return redirect()->to('/HistoryFasilitas/SmokeHeatDetector')->with('pesan', 'Izin Berhasil Diapprove');
    }
    ...
    public function rejected($id)
    {
        ...
        return redirect()->to('/HistoryFasilitas/SmokeHeatDetector')->with('pesan', 'Izin Berhasil Direject');
    }
    ...
    public function returned($id)
    {
        ...
        return redirect()->to('/HistoryFasilitas/SmokeHeatDetector')->with('pesan', 'Izin Berhasil Direturn');
    }
    ...
    public function listPengaktifan($id = false)
    {
        ...
        $data = [
            'title' => 'List Pengaktifan Akses Smoke / Heat Detector',
            'kategori' => $this->kategoriModel->getKategori(),
            'page' => $page,
            'perPage' => $perPage,
            'total' => $total,
        ...
        return view('/ApproveFasilitas/List/PengaktifanSmokeHeatDetector', $data);
    }
    ...
    public function detailPengaktifan($id = false)
    {
        ...
        $data = [
            'title' => 'Detail Pengaktifan Akses Smoke / Heat Detector',
            'kategori' => $this->kategoriModel->getKategori(),
            'foto_izin' => $this->db->table('foto_izin_fasilitas')->getWhere(['id_izin' => $id])->getResultArray(),
            'aktifasi_on' => $this->aktifasiModel->getUserAktifasi($id),
            'aktifasi_pic' => $this->aktifasiModel->getUserAktifasi2($id),
        ...
        return view('/ApproveFasilitas/Detail/DetailsAktifSmokeHeatDetector', $data);
    }
    ...
    public function PICPengaktifan($id)
    {
        ...
        return redirect()->to('/PengaktifanFasilitas/SmokeHeatDetector/Details/' . $id)->with('pesan', 'Izin Pengaktifan Berhasil Diapprove');
    }
    ...
    public function listHistory($id = false)
    {
        ...
        $data = [
            'title' => 'List History Perizinan Smoke / Heat Detector',
            'kategori' => $this->kategoriModel->getKategori(),
            'page' => $page,
            'perPage' => $perPage,
            'total' => $total,
        ...
        return view('/ApproveFasilitas/List/HistorySmokeHeatDetector', $data);
    }
    ...
    public function listExtend($id = false)
    {
        ...
        $data = [
            'title' => 'List Extended Perizinan Smoke / Heat Detector',
            'kategori' => $this->kategoriModel->getKategori(),
            'page' => $page,
            'perPage' => $perPage,
            'total' => $total,
        ...
        return view('/ApproveFasilitas/List/ExtendSmokeHeatDetector', $data);
    }
    ...
    public function extend($id)
    {
        ...
        return redirect()->to('/ExtendFasilitas/SmokeHeatDetector')->with('pesan', 'Permohonan Extend Izin Berhasil Diapprove');
    }
}
