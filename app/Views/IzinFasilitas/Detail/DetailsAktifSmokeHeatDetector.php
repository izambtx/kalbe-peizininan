...
<div class="container-fluid mb-5 justify-content-center">
    ...
    <div class="card text-center shadow pt-5">
        ...
        <form class="" action="/PenonAktifanFasilitas/SmokeHeatDetector/<?= $pintu['id']; ?>" method="post">
            <?= csrf_field(); ?>
            ...
            <div class="row my-4 mx-3">
                ...
                <div class="col-auto my-auto">
                    <!-- <a target="_blank" href="/IzinFasilitas/SmokeHeatDetector/Details/<?= $pintu['id']; ?>" class="cssbuttons-io-button">
        ...
        <?php if ($aktifasi_izin['off_at']) : ?>
            <form action="/PenonAktifanFasilitas/aktif/SmokeHeatDetector/<?= $aktifasi_izin['id']; ?>" method="post">
                <?= csrf_field(); ?>
                <div class="row my-4 mx-3">
                    <div class="col-auto mr-auto my-auto">
                        <div class="text-left ml-4">
...
<div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <?= $this->include('ModalDetailPerizinan/ModalDetailSmokeHeatDetector'); ?>
            </div>
        </div>
    </div>
</div>
