...
<div class="container-fluid mb-5 justify-content-center">
    ...
    <div class="card text-center shadow pt-5">
        ...
        <form class="" action="/PenonAktifanFasilitas/FireAlarm/<?= $pintu['id']; ?>" method="post">
            ...
            <div class="row my-4 mx-3">
                ...
                <div class="col-auto my-auto">
                    <!-- <a target="_blank" href="/IzinFasilitas/FireAlarm/Details/<?= $pintu['id']; ?>" class="cssbuttons-io-button">
        ...
        <?php if ($aktifasi_izin['off_at']) : ?>
            <form action="/PenonAktifanFasilitas/aktif/FireAlarm/<?= $aktifasi_izin['id']; ?>" method="post">
                <?= csrf_field(); ?>
                <div class="row my-4 mx-3">
                    <div class="col-auto mr-auto my-auto">
                        <div class="text-left ml-4">
