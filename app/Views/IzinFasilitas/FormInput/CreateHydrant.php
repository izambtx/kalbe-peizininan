...
<div class="container-fluid justify-content-center mb-5">
    ...
    <div class="card text-center shadow mx-auto pt-5">
        ...
        <div class="d-inline my-3">
            <?php foreach ($kategori as $k) : ?>
                <div class="custom-control custom-checkbox custom-control-inline">
                    <input <?php if ($k['nama_kategori'] == 'Hydrant') : ?>checked<?php else : ?>disabled<?php endif ?> class="is-valid custom-control-input" type="checkbox" id="<?= $k['nama_kategori']; ?>" value="<?= $k['nama_kategori']; ?>">
            ...
            <div class="form-group row">
                ...
                <div class="form-row col-sm-12 px-0">
                    ...
                    <div class="form-group col-sm-5 my-auto">
                        <input type="number" value="" min="0" max="8" class="form-control rounded-sm" id="jumlahFoto" name="jumlahFoto" placeholder="Masukan Jumlah Foto OPL Yang Diperlukan" value="<?= $inputFotoPE; ?>">
                    </div>
        ...
        <form class="mx-5 mt-2 mb-5 px-5 text-left" method="post" action="/IzinFasilitas/Hydrant/SaveIzin" enctype="multipart/form-data">
            <?php csrf_field(); ?>

            <?php $jumlahFoto = $inputFotoPE ?>
                        ...
                        <div class="media-body mx-3">
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="custom-file col-sm-10 my-2">
                                    ...
                                    <label class="custom-file-label" data-browse="Choose" id="label_sebelum<?= $i; ?>" name="label_sebelum<?= $i; ?>" for="foto_sebelum<?= $i; ?>">Choose image / Drop image here</label>
                                </div>
                            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" readonly disabled class="form-control rounded-sm" id="exampleFormControlInput1" value="<?= date('l, d F Y / h.i A'); ?>">
            </div>
            <div class="form-group">
                ...
                <div class="input-group my-3">
                    <select class="custom-select rounded-sm" id="lokasi_2" name="lokasi_2">
                        ...
                        <?php foreach ($lokasi as $d) : ?>
                            <option value="<?= $d['id'];  ?>" <?= old('lokasi_2') == $d['id'] ? 'selected' : '' ?>><?= $d['nama_lokasi'];  ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="input-group">
                    <select class="custom-select rounded-sm" id="lokasi_3" name="lokasi_3">
                        ...
                        <?php foreach ($lokasi as $d) : ?>
                            <option value="<?= $d['id'];  ?>" <?= old('lokasi_3') == $d['id'] ? 'selected' : '' ?>><?= $d['nama_lokasi'];  ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control rounded-sm <?php if (session('validation.titik')) : ?>is-invalid<?php endif ?>" name="titik" id="titik" placeholder="Jumlah Titik Yang Akan Dipakai">
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <div class="row">
                    <div class="col">
                        <input type="datetime-local" class="form-control rounded-sm <?php if (session('validation.penggunaan')) : ?>is-invalid<?php endif ?>" name="penggunaan" id="penggunaan">
                        <div class="invalid-feedback">
                    ...
                    <div class="col">
                        <input type="datetime-local" class="form-control rounded-sm <?php if (session('validation.nonaktif')) : ?>is-invalid<?php endif ?>" name="nonaktif">
                        <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input type="datetime-local" class="form-control rounded-sm <?php if (session('validation.target')) : ?>is-invalid<?php endif ?>" name="target" id="target">
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control rounded-sm <?php if (session('validation.keperluan')) : ?>is-invalid<?php endif ?>" name="keperluan" id="keperluan" placeholder="Keterangan keperluan">
                <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control rounded-sm <?php if (session('validation.rencana')) : ?>is-invalid<?php endif ?>" name="rencana" id="rencana" rows="5" placeholder="Keterangan Rencana Antisipasi"></textarea>
                <div class="invalid-feedback">
