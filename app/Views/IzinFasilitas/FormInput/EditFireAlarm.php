...
<div class="container-fluid justify-content-center mb-5">
    ...
    <div class="card text-center shadow mx-auto pt-5">
        ...
        <form class="mx-5 mt-2 mb-5 px-5 text-left" method="post" action="/IzinFasilitas/FireAlarm/UpdateIzin/<?= $pintu['id']; ?>" enctype="multipart/form-data">
            <?php csrf_field(); ?>
                ...
                <div id="inputImage">
                    <div class="media mb-4">
                        <div class="d-block my-auto col-sm-3 border-0" id="row">
                            <img src="/img/<?= $FPE['nama_foto']; ?>" id="img" class="img-thumbnail col-sm-12 p-0 sebelum-preview<?= $i; ?> rounded" alt="Gambar Fire Alarm">
                        </div>
