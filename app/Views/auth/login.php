                            ...
                            <div class="p-5 mt-4">
                                ...
                                <form class="user" action="<?= url_to('login') ?>" method="post">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control bg-light border-left-0 border-right-0 form-control-user <?php if (session('errors.login')) : ?>is-invalid<?php endif ?>" name="login" placeholder="NIK" aria-label="login" aria-describedby="basic-addon1">
