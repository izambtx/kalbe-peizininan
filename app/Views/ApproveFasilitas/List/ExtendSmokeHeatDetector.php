        ...
        <div class="row my-4 mx-3">
            <div class="col-auto mr-auto my-auto">
                <div class="d-flex justify-content-around ">
                    <span class="text-gray-900 h4 my-auto"><img src="/img/smoke-detector.png" alt="" style="width:40px;"></span>
                    <div class="d-inline h5 text-gray-900 ml-3 my-auto align-middle font-weight-bold">
                        <span class="align-middle">Smoke / Heat Detector</span>
                    </div>
                </div>
            </div>
                ...
                <?php foreach ($pintu as $p) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else : ?>
                                <a href="/ApproveFasilitas/SmokeHeatDetector/Details/<?= $p['id_izin']; ?>">
                    ...
                    <div class="modal fade" id="detailModal<?= $i; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content mb-0 rounded border-0">
                                ...
                                <form action="/ExtendFasilitas/SmokeHeatDetector/<?= $p['id']; ?>" method="post">
                                    <?= csrf_field(); ?>
