...
<div class="container-fluid mb-5 justify-content-center">
    ...
    <div class="card text-center shadow pt-5">
        ...
        <form class="" action="/PenonAktifanFasilitas/FireAlarm/<?= $pintu['id']; ?>" method="post">
            <?= csrf_field(); ?>
            ...
            <div class="row my-4 mx-3 d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-end">
                    <!-- <a target="_blank" href="/ApproveFasilitas/FireAlarm/Details/<?= $pintu['id']; ?>" class="cssbuttons-io-button">
        ...
        <?php if ($pintu['agreed_at']) : ?>
            <form class="" action="/PengaktifanFasilitas/FireAlarm/<?= $aktifasi_izin['id']; ?>" method="post">
                <?= csrf_field(); ?>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <?php if (in_groups('manager')) : ?>
                        <form action="/PengaktifanFasilitas/FireAlarm/approve/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
                    ...
                    <?php elseif (in_groups('engineer')) : ?>
                        <form action="/PengaktifanFasilitas/FireAlarm/check/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
                            <input type="hidden" value="<?= $aktifasi_izin['id']; ?>" id="id_aktifasi" name="id_aktifasi">
                            <div class="form-group row mb-0 mt-5">
                                <label for="lokasi1" class="col-sm-4 col-form-label">Lokasi </label>
                    ...
                    <?php elseif (in_groups('ERT')) : ?>
                        <form action="/PengaktifanFasilitas/FireAlarm/agree/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
                            <input type="hidden" value="<?= $aktifasi_izin['id']; ?>" id="id_aktifasi" name="id_aktifasi">
                            <div class="form-group row mb-0 mt-5">
                                <label for="lokasi1" class="col-sm-4 col-form-label">Lokasi </label>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <?php if (in_groups('manager')) : ?>
                        <form action="/PengaktifanFasilitas/FireAlarm/approve2/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <?php if (in_groups('manager')) : ?>
                        <form action="/PengaktifanFasilitas/FireAlarm/approve3/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
...
<div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <?= $this->include('ModalDetailPerizinan/ModalDetailFireAlarm'); ?>
            </div>
        </div>
    </div>
</div>
