        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/ReturnFasilitas/1/PintuEmergency/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/ReturnFasilitas/2/PintuEmergency/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/ReturnFasilitas/3/PintuEmergency/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/RejectFasilitas/1/PintuEmergency/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/RejectFasilitas/2/PintuEmergency/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/RejectFasilitas/3/PintuEmergency/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <?php if (in_groups('manager')) : ?>
                        <form action="/ApproveFasilitas/PintuEmergency/approve/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
                    ...
                    <?php elseif (in_groups('engineer')) : ?>
                        <form action="/ApproveFasilitas/PintuEmergency/check/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
                            <div class="form-group row mb-0 mt-5">
                    ...
                    <?php elseif (in_groups('OHSE')) : ?>
                        <form action="/ApproveFasilitas/PintuEmergency/read/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
                            <div class="form-group row mb-0 mt-5">
                                <label for="lokasi1" class="col-sm-4 col-form-label">Lokasi </label>
                                <div class="col-sm-8">
                    ...
                    <?php elseif (in_groups('ERT')) : ?>
                        <form action="/ApproveFasilitas/PintuEmergency/agree/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
                            <div class="form-group row mb-0 mt-5">
                                <label for="namaproject" class="col-sm-4 col-form-label">Lokasi </label>
                                <div class="col-sm-8">
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <?php if (in_groups('manager')) : ?>
                        <form action="/ApproveFasilitas/PintuEmergency/approve2/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <?php if (in_groups('manager')) : ?>
                        <form action="/ApproveFasilitas/PintuEmergency/approve3/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
