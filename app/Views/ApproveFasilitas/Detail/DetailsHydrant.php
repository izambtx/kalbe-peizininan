            ...
            <table class="table table-bordered text-gray-900 my-auto">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="max-width: 7rem;">
                            <?php if ($pintu['status'] == 'Approved Spv/Mgr' && in_groups('ERT') && stripos($pintu['status'], 'Returned') == TRUE && empty($pintu['agreed_at']) && stripos($pintu['status'], 'Rejected') == TRUE) : ?>
                                <button type="button" class="btn btn-warning btn-sm btn-block mt-2" data-toggle="modal" data-target="#returnModal">Return</button>
                                <button type="button" class="btn btn-danger btn-sm btn-block" data-toggle="modal" data-target="#rejectModal">Reject</button>
                                <button type="button" class="btn btn-success btn-sm btn-block" data-toggle="modal" data-target="#approveModal">Approve</button>
                                <br>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/ReturnFasilitas/1/Hydrant/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/ReturnFasilitas/2/Hydrant/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/ReturnFasilitas/3/Hydrant/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/RejectFasilitas/1/Hydrant/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/RejectFasilitas/2/Hydrant/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/RejectFasilitas/3/Hydrant/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <?php if (in_groups('manager')) : ?>
                        <form action="/ApproveFasilitas/Hydrant/approve/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
                    ...
                    <?php elseif (in_groups('engineer')) : ?>
                        <form action="/ApproveFasilitas/Hydrant/check/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
                            <div class="form-group row mb-0 mt-5">
                    ...
                    <?php elseif (in_groups('OHSE')) : ?>
                        <form action="/ApproveFasilitas/Hydrant/read/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
                            <div class="form-group row mb-0 mt-5">
                                <label for="lokasi1" class="col-sm-4 col-form-label">Lokasi </label>
                                <div class="col-sm-8">
                    ...
                    <?php elseif (in_groups('ERT')) : ?>
                        <form action="/ApproveFasilitas/Hydrant/agree/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
                            <div class="form-group row mb-0 mt-5">
                                <label for="namaproject" class="col-sm-4 col-form-label">Lokasi </label>
                                <div class="col-sm-8">
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <?php if (in_groups('manager')) : ?>
                        <form action="/ApproveFasilitas/Hydrant/approve2/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <?php if (in_groups('manager')) : ?>
                        <form action="/ApproveFasilitas/Hydrant/approve3/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
