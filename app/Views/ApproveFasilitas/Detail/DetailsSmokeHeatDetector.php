        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/ReturnFasilitas/1/SmokeHeatDetector/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/ReturnFasilitas/2/SmokeHeatDetector/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/ReturnFasilitas/3/SmokeHeatDetector/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/RejectFasilitas/1/SmokeHeatDetector/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/RejectFasilitas/2/SmokeHeatDetector/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <form action="/RejectFasilitas/3/SmokeHeatDetector/<?= $pintu['id']; ?>" method="post">
                        <?= csrf_field(); ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <?php if (in_groups('manager')) : ?>
                        <form action="/ApproveFasilitas/SmokeHeatDetector/approve/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
                    ...
                    <?php elseif (in_groups('engineer')) : ?>
                        <form action="/ApproveFasilitas/SmokeHeatDetector/check/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
                            <div class="form-group row mb-0 mt-5">
                    ...
                    <?php elseif (in_groups('OHSE')) : ?>
                        <form action="/ApproveFasilitas/SmokeHeatDetector/read/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
                            <div class="form-group row mb-0 mt-5">
                                <label for="lokasi1" class="col-sm-4 col-form-label">Lokasi </label>
                                <div class="col-sm-8">
                    ...
                    <?php elseif (in_groups('ERT')) : ?>
                        <form action="/ApproveFasilitas/SmokeHeatDetector/agree/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
                            <div class="form-group row mb-0 mt-5">
                                <label for="namaproject" class="col-sm-4 col-form-label">Lokasi </label>
                                <div class="col-sm-8">
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <?php if (in_groups('manager')) : ?>
                        <form action="/ApproveFasilitas/SmokeHeatDetector/approve2/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
        ...
        <div class="modal-content mb-0 rounded-md border-0">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <?php if (in_groups('manager')) : ?>
                        <form action="/ApproveFasilitas/SmokeHeatDetector/approve3/<?= $pintu['id']; ?>" method="post">
                            <?= csrf_field();  ?>
